...
[![Build Status](https://travis-ci.org/bitum/politeiagui.svg?branch=master)](https://travis-ci.org/bitum/politeiagui)

Politeiagui is the web frontent for [Politiea](https://github.com/bitum/politeia), Bitum's [proposal system](https://proposals.bitum.io/). 
...
- [politeiawww](https://github.com/bitum-project/politeia)
...
1. Clone this repository
    ...
    `https://github.com/bitum-project/politeiagui.git`
...
```bash
$ docker run -d --rm -p <local port>:80 bitum/politeiagui:latest
```
